...
spinal_cord_slices=(40 60 80 100 120 140 160 180)
task=tens
...
for run in ${runs[@]}; do
	for cope in ${copes[@]}; do
		...
		fslroi ${cope}_overlay_t2 ${cope}_overlay_t2 12 51 0 -1 35 155
		...
		pngappend ${task}_${cope}_z_180.png - ${task}_${cope}_z_160.png - ${task}_${cope}_z_140.png -  ${task}_${cope}_z_120.png - ${task}_${cope}_z_100.png - ${task}_${cope}_z_80.png - ${task}_${cope}_z_60.png - ${task}_${cope}_z_40.png ${cope}_${type}_${run}.png
