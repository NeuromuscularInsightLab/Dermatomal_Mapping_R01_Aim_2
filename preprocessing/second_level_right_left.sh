...
output_path=${data_path}/results/subject_level_right_left
...
for subject in ${subjects[@]}; do
        ...
        smoothing=0
        export FSLDIR output_path scripts_path subject task analysis_path smoothing data_path
        ...
        cd ${subject}_right_vs_left.feat # todo
        mkdir -p reg
